...
const SettingsWindow = ({
          ...
          {themeOptions.map((theme) => (
            <div
              ...
              style={{
                ...
                borderRadius: `${settings.cardBorderRadius}px`,
                border: `2px solid ${
                  settings.theme === theme.id ? colors.accent : colors.border
                }`,
                backgroundColor:
  ...
  const renderTabContent = () => {
    switch (activeTab) {
          ...
          <div>
            ...
            >
              ...
              >
                ...
                <div
                  onClick={() =>
                    handleSettingChange("showSidebar", !settings.showSidebar)
                  }
                  style={{
                    width: "48px",
                    height: "24px",
                    backgroundColor: settings.showSidebar
                      ? colors.accent
                      : colors.border,
                    borderRadius: "12px",
                    cursor: "pointer",
      ...
      default:
        return (
          <div style={{ color: colors.text }}>Content for {activeTab} tab</div>
        );
    }
  };
    ...
    <div style={settingsStyles.overlay} onClick={onClose}>
      <div style={settingsStyles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={settingsStyles.content}>
          ...
          <div style={settingsStyles.main}>{renderTabContent()}</div>
        </div>
...
const AdminPage = () => {
  ...
  const navigateBack = () => {
    ...
    setActiveSection(previousSection || "top setups");
  ...
  const NAVIGATION_ITEMS = [
    ...
    { id: "data entry", label: "Economic Indicator Entry", icon: Monitor },
  ];
  ...
  const dynamicStyles = {
    container: {
      ...
      color: colors.text,
      fontSize:
        dashboardSettings.fontSize === "large"
          ? "18px"
          : dashboardSettings.fontSize === "small"
          ? "14px"
          : "16px",
      transition: dashboardSettings.enableAnimations ? "all 0.3s ease" : "none",
    },
    sidebar: {
      width: dashboardSettings.showSidebar
        ? `${dashboardSettings.sidebarWidth}px`
        : "0",
      backgroundColor: colors.sidebar,
      borderRight: `1px solid ${colors.border}`,
      minHeight: "100vh",
    ...
    sidebarContent: {
      padding: dashboardSettings.showSidebar
        ? `${dashboardSettings.cardPadding}px`
        : "0",
    ...
    navButton: {
      ...
      alignItems: "center",
      gap: "12px",
      padding: `${Math.floor(dashboardSettings.cardPadding / 2)}px ${
        dashboardSettings.cardPadding
      }px`,
      borderRadius: `${dashboardSettings.cardBorderRadius}px`,
      textAlign: "left",
      border: "none",
            ...
            <button
              ...
              style={{
                ...
                ...(activeSection === item.id
                  ? dynamicStyles.navButtonActive
                  : dynamicStyles.navButtonInactive),
              }}
              onMouseEnter={(e) => {
                if (
                  activeSection !== item.id &&
                  dashboardSettings.enableHoverEffects
                ) {
  ...
  const Header = () => (
    <div style={dynamicStyles.header}>
      ...
      >
        <div>
          {/* Add back button for currency profile */}
          {activeSection === "currency-profile" && (
            <button
              onClick={navigateBack}
              style={dynamicStyles.backButton}
            >
              <ArrowLeft size={16} />
              Back to {previousSection === "top setups" ? "Top Setups" : "Dashboard"}
            </button>
          )}
          ...
          >
            {activeSection === "currency-profile" 
              ? `Currency Profile - ${currentAssetPair}` 
              : activeSection}
          </h1>
          <div
            style={{
        ...
        >
          <div>
            ...
            <p style={{ color: "#bfdbfe", margin: "8px 0 0 0" }}>
              Your AI-powered trading companion is ready. Let's make confident
              decisions together.
            </p>
    ...
    return (
      <div
        style={{
          display: "grid",
          gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))",
          gap: `${dashboardSettings.cardPadding}px`,
          marginBottom: `${dashboardSettings.cardPadding}px`,
        }}
      >
    ...
    return (
      <div style={dynamicStyles.card}>
        ...
        >
          ...
          <button
            onClick={() => setActiveSection("top setups")}
            style={{
              padding: "6px 12px",
              backgroundColor: colors.accent,
              color: "#ffffff",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {STATIC_MARKET_DATA.topSetups.map((setup, index) => (
            <div
              ...
              onClick={() => navigateToCurrencyProfile(setup.symbol)}
            >
              <div
        ...
        return (
          <div style={{ padding: `${dashboardSettings.cardPadding}px` }}>
            <div style={dynamicStyles.card}>
              ...
              <p style={{ color: colors.textSecondary }}>
                Advanced sentiment analysis tools and indicators coming soon.
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div style={{ padding: `${dashboardSettings.cardPadding}px` }}>
            <div style={dynamicStyles.card}>
              ...
              <p style={{ color: colors.textSecondary }}>
                Risk management tools and position sizing calculators coming soon.
              </p>
            </div>
          </div>
        );
