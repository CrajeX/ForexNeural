...
//   // Add navigate hook (assuming you're using React Router)
...
//     if (success) {
//       // Apply settings to the parent component
...
//         // Navigate to login page (uncomment if using React Router)
//         // navigate('/');
        
//         // Or reload the page to redirect to login
...
//   // Get theme colors and styles using utility functions
...
//   // Fixed logout tab render
//   const renderLogoutTab = () => (
//     <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
//       <div>
//         <h3 style={{ color: colors.text, marginBottom: '16px' }}>Account Actions</h3>
...
//         </div>
//         <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
//           <span style={{ color: colors.text }}>Compact Mode</span>
//           <div
...
//               transition: 'all 0.2s'
//             }}
//             onMouseEnter={(e) => e.target.style.backgroundColor = `${colors.border}40`}
...
const TradingDashboard = () => {
  ...
  const name = sessionData?.name || 'Trader';
